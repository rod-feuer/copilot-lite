    ...
    <ToastCtx.Provider value={toast}>
      ...
      <div className="pointer-events-none fixed bottom-4 right-4 z-50 flex w-80 max-w-[calc(100vw-2rem)] flex-col gap-2">
        {toasts.map((t) => (
          <div
            key={t.id}
            className="pointer-events-auto flex items-start gap-2.5 rounded-xl border border-[var(--border)] bg-card px-3.5 py-2.5 text-[13px] shadow-[0_8px_24px_rgba(16,24,40,0.16)]"
          >
